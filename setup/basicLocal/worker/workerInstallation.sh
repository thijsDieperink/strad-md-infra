...
branectl generate node -f -H localhost:127.0.0.1 worker localhost workerlocal

# Generate certificate
echo "--------------Create certificate--------------"
branectl generate certs -f -p ./config/certs server workerlocal -H host.docker.internal
